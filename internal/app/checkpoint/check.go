...
func Check(projectPath string) {
	...
	// Note: Project context and recent context removed to reduce file size
	// LLM can read .checkpoint/project.yaml and .checkpoint-context.yaml directly if needed
