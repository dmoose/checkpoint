...
func listExamples(examplesDir string) {
	...
	fmt.Println()
	fmt.Println("Usage:")
	fmt.Println("  guardrail examples [category]")
	fmt.Println()
	fmt.Println("Examples:")
	fmt.Println("  guardrail examples feature")
	fmt.Println("  guardrail examples bugfix")
	fmt.Println("  guardrail examples anti-patterns")
	fmt.Println()
}
...
func showExample(examplesDir string, category string) {
	...
	if !file.Exists(examplePath) {
		...
		fmt.Fprintf(os.Stderr, "Run 'guardrail examples' to see available examples\n")
		os.Exit(1)
	}
