...
func listGuides() {
	...
	fmt.Println()
	fmt.Println("Usage:")
	fmt.Println("  guardrail guide [topic]")
	fmt.Println()
	fmt.Println("Examples:")
	fmt.Println("  guardrail guide first-time-user")
	fmt.Println("  guardrail guide llm-workflow")
	fmt.Println("  guardrail guide best-practices")
	fmt.Println()
}
...
func showGuide(topic string) {
	...
	if !ok {
		...
		fmt.Fprintf(os.Stderr, "Run 'guardrail guide' to see available guides\n")
		os.Exit(1)
	}
